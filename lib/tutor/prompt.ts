...
- Name a case by its ending, checked against the table below, and only then by its name. An -s on a place is the seesütlev and an -l is the alalütlev, and mixing those two names up is the commonest slip a teacher makes in English, so do not.
