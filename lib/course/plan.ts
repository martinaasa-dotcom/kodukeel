...
export const PARTS: readonly PartSpec[] = [
  ...
  },
  {
    ...
    blurb:
      "Adjectives, colors, clothes and weather, and then the shop where you use all four. "
      + "At the end you can say what something is like and buy it.",
    units: ["omadussonad", "varvid", "riided", "ilm", "ostmine"],
  },
  {
    id: "a1.4", level: "A1",
    title: "Kus, kes, millal", subtitle: "Places, questions, pronouns and when",
    blurb:
      "The words a sentence is built out of rather than the ones it is about. At the end you "
      + "can ask where something is, say where you are going, and answer when.",
    units: ["kus-ja-kuhu", "kusisonad", "asesonad", "millal", "kohasonad"],
  },
  {
    id: "a1.5", level: "A1",
    title: "Kuud, riigid ja sidesõnad", subtitle: "The calendar, the world, and joining two thoughts",
    blurb:
      "The last of A1: the months, where people are from, and the small words that turn two "
      + "sentences into one. At the end you have every word A1 asks for.",
    units: ["sidesonad", "vastused", "maaramine", "kuud", "riigid"],
  },
