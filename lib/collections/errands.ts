 ...
 * two disconnected fragments rather than as "try it at work, or at a party".
 * `joinWithOr` is the right reading, because these are places any one of
 * which would do, not a list of places to visit.
 */
