...
export const A1 = [
  unit({
    ...
    */
    ...
    words: [
      ["tere", "hello", "ADVERB", 244181],
      ["aitäh", "thank you", "ADVERB", 155605],
      ["jah", "yes", "ADVERB", 173447],
      ["ei", "no, not", "ADVERB", 162857],
  ...
  unit({
    ...
    */
    ...
    requires: ["vastused"],
    words: [
      ["mina", "I, me", "PRONOUN", 1348787],
      ["sina", "you (one person)", "PRONOUN", 233833],
      ["tema", "he, she", "PRONOUN"],
      ["meie", "we, us", "PRONOUN"],
      ["teie", "you (several people, or one politely)", "PRONOUN", 243417],
  ...
  unit({
    ...
    */
    ...
    words: [
      ...
      ["töötama", "to work"],
      ["tahtma", "to want"],
      ["minema", "to go", "VERB", 202944],
      ["tulema", "to come", "VERB", 247802],
    ],
    evenings: [
  ...
  unit({
    ...
    words: [
      ...
      ["naine", "woman, wife"],
      ["mees", "man, husband", "NOUN", 201392],
      ["laps", "child"],
      ["sõber", "friend"],
      ["ema", "mother"],
      ["isa", "father"],
      ["pere", "family"],
      ["vend", "brother", "NOUN", 255508],
      ["õde", "sister"],
      ["tütar", "daughter"],
      ["poeg", "son"],
  ...
  unit({
    ...
    words: [
      ...
      */
      ...
      ["kolm", "three"],
      ["neli", "four"],
      ["viis", "five", "NOUN", 256707],
      ["kuus", "six"],
      ["seitse", "seven"],
      ["kaheksa", "eight", "NOUN", 176412],
      ["üheksa", "nine"],
      ["kümme", "ten"],
      ["üksteist", "eleven"],
      ["kaksteist", "twelve"],
  ...
  unit({
    ...
    words: [
      ["aeg", "time"],
      ["päev", "day"],
      ["öö", "night", "NOUN", 262254],
      ["hommik", "morning"],
      ["õhtu", "evening"],
      ["nädal", "week"],
      ["kuu", "month, moon", "NOUN", 188398],
      ["aasta", "year"],
      ["tund", "hour, lesson"],
      ["minut", "minute"],
      ["kell", "clock, o'clock"],
  ...
  unit({
    ...
    words: [
      ...
      ["sööma", "to eat", "VERB", 239553],
      ["jooma", "to drink", "VERB", 174011],
      ["tooma", "to bring"],
  ...
  unit({
    ...
    */
    ...
    words: [
      ...
      ["kerge", "easy, light", "ADJECTIVE", 180090],
  ...
  unit({
    ...
    words: [
      ...
      ["seelik", "skirt"],
      ["king", "shoe"],
      ["sokk", "sock", "NOUN", 234953],
      ["müts", "hat", "NOUN", 206527],
      ["mantel", "coat"],
      ["jope", "jacket"],
      ["sall", "scarf"],
      ["kinnas", "glove"],
  ...
  unit({
    ...
    words: [
      ...
      ["linn", "town, city"],
      ["tänav", "street"],
      ["tee", "road, tea", "NOUN", 242936],
      ["buss", "bus"],
      ["rong", "train"],
      ["auto", "car", "NOUN", 159100],
      ["jaam", "station"],
      ["park", "park", "NOUN", 213988],
  ...
  unit({
    ...
    words: [
      ...
      ["sild", "bridge"],
      ["nurk", "corner"],
      ["kool", "school", "NOUN", 185065],
      ["töö", "work"],
      ["haigla", "hospital"],
      ["kirik", "church"],
      ["rand", "beach", "NOUN", 225669],
      ["ülikool", "university"],
      ["kohvik", "café"],
      ["restoran", "restaurant"],
      ["hotell", "hotel"],
      ...
      */
      ...
      ["otse", "straight on", "ADVERB", 212082],
  ...
  */
  ...
  unit({
    ...
    requires: ["asesonad"],
    words: [
      ["ise", "self, myself, yourself", "PRONOUN", 172994],
  ...
  unit({
    ...
    words: [
      ...
      ["sest", "because", "ADVERB"],
      ["kuna", "since, because", "ADVERB", 187756],
      ["ega", "nor", "ADVERB"],
  ...
  unit({
    ...
    words: [
      ...
      ["vist", "probably, I think", "ADVERB", 257399],
      ["äkki", "maybe, suddenly", "ADVERB"],
      ["küll", "indeed, do (an emphasizing word)", "ADVERB", 191080],
      ["eks", "right? (asking for agreement)", "ADVERB", 162998],
      ...
      ["õige", "right, correct", "ADJECTIVE", 260695],
    ],
  }),
  ...
  unit({
    ...
    words: [
      ...
      ["natuke", "a little", "ADVERB", 207578],
      ["üldse", "at all", "ADVERB"],
      ["eriti", "especially", "ADVERB"],
      ["sama", "the same", "ADVERB", 230878],
      ["uuesti", "again", "ADVERB"],
  ...
  */
  ...
  unit({
    ...
    words: [
      ["Eesti", "Estonia"],
      ["Soome", "Finland", "NOUN", 235404],
      ["Läti", "Latvia", "NOUN", 198342],
      ["Venemaa", "Russia"],
      ["Rootsi", "Sweden", "NOUN", 228854],
      ["Saksamaa", "Germany"],
      ["Inglismaa", "England"],
      ["Ameerika", "America"],
      ["Euroopa", "Europe"],
