...
| AI | no SDK: one HTTP client over a chain of providers | `lib/tutor/provider.ts`, Groq then Gemini then a bounded Anthropic and OpenAI tail, per `13-mvp-status.md` §2 |
