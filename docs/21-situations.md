...
3. **Composed.** A model is given the move, the beat, the closed word list and the run so far, and
   ...
   all. Which of the two, for the whole of a run, is §50.
...
uses; §50 has what that is worth, and what it cost while the list sat on the wrong side of it.
...
**The numbers below were written before there were any, and §50 has the measured ones**: a composed
...
## 50. Composed for the whole run, or scripted for the whole run
