...
above is true of the 1,545 words a unit names and was false of the 5,363 the Wiktionary expansion
...
written down the course's label and Ekilex's agree on all 1,545 words. `PRONOUN` is a part of speech for it, harvested as a nominal
...
1,545 course words. Four codes are nearly all of it, and the fact that they are the four is the
...
shipped entries and 30 of the course's own 1,545 words were taught with a capital that is theirs
...
`prisma/data/harvested.ts`: `seedSize.test.ts` counts 6,184 entries against the expansion's 5,363,
